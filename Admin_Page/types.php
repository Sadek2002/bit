        ...
        <div class="col-lg-4" style="width: 100%">
            ...
            <form action="" name="form1" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="product_type" placeholder="Enter New Type"
            ...
            <div class="col-lg-12">
                <table class="table table-bordered">
                    ...
                    foreach ($db->getTableByName("product_types") as $row) {
                        ...
                        echo "</td>";
                        echo "<td>"; ?> <a href="delete_types.php?type=<?php echo $row["product_type"]; ?>"
        ...
        <div class="col-lg-4" style="width: 100%">
            ...
            <form action="" name="form1" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="color" placeholder="Enter New Color" name="color"
                           required>
                </div>
                <div class="button">
            ...
            <div class="col-lg-12">
                <table class="table table-bordered">
                    ...
                    foreach ($db->getTableByName("colors") as $row) {
                        ...
                        echo $row["color"];
                        echo "</td>";
                        echo "<td>"; ?> <a href="delete_types.php?color=<?php echo $row["color"]; ?>"
                        <button type="button" class="btn btn-danger">Delete</button></a> <?php echo "</td>";
                    }
                    ?>
                    </thead>
